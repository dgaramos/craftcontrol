...
class CraftControlBrandTest(unittest.TestCase):
    ...
    def test_player_feature_separates_workspace_profile_access_history_and_telemetry(self) -> None:
        ...
        for name, factory in {
            ...
            self.assertIn(f'from "./{name}.js?v=3"', index)
        self.assertIn('from "./features/players/index.js?v=3"', script)
    ...
    def test_browser_api_attaches_session_bound_csrf_header(self) -> None:
        ...
        self.assertIn('./api.js?v=3', app_script)
        self.assertIn('./api.js?v=3', auth_script)
    ...
    def test_split_frontend_reports_its_own_release_version(self) -> None:
        ...
        self.assertIn("CRAFTCONTROL_FRONTEND_VERSION=0.2.2", dockerfile)
    ...
    def test_frontend_core_owns_shared_state_and_dom_primitives(self) -> None:
        ...
        self.assertIn('from "./core/state.js?v=3"', script)
        self.assertIn('from "./core/dom.js?v=3"', script)
    ...
    def test_frontend_components_own_feedback_and_time_primitives(self) -> None:
        ...
        self.assertIn('from "./components/feedback.js?v=3"', script)
        self.assertIn('from "./components/time.js?v=3"', script)
    ...
    def test_analytics_activity_and_deaths_have_a_feature_boundary(self) -> None:
        ...
        self.assertIn('from "./features/analytics/index.js?v=3"', script)
        self.assertIn('from "./activity.js?v=3"', index)
    ...
    def test_interface_uses_custom_icons_and_bilingual_block_labels(self) -> None:
        ...
        self.assertIn('import { es } from "./es.js?v=3"', i18n)
