...
export async function showSessions() {
  ...
  let data;
  try { data = await api("/api/auth/sessions"); }
  catch { window.alert(words.requestFailed); return; }
