...
export function createPlayerProfile({ state, content, t, localized, api, $, escapeHtml, formatDate, formatDuration, playerDataMarkup, profileMarkup, booleanControl, panelAccessDetailMarkup, renderPlayersPanel, renderAnalyticsPanel, renderTabs, updateToggleLabel, toast, bindPlayerAccess }) {
