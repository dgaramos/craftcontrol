...
export type ServerOperation = { operation_id?: string; server_id?: string; state?: "pending" | "running" | "confirmed" | "failed" | "divergent"; requested_changes?: { [key: string]: unknown; }; stages?: Array<OperationStageRecord>; created_at?: string; updated_at?: string; completed_at?: string; terminal_error?: string; observation?: { [key: string]: unknown; }; correlation_id?: string; parent_operation_id?: string; };
export type OperationStageRecord = { stage?: string; result?: "pending" | "running" | "completed" | "failed" | "skipped"; started_at?: string; completed_at?: string; evidence?: { [key: string]: unknown; }; error?: string; };
