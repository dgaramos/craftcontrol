...
class CraftControlBrandTest(unittest.TestCase):
    ...
    def test_player_feature_separates_workspace_profile_access_history_and_telemetry(self) -> None:
        ...
        for name, factory in {
            ...
            self.assertIn(f'from "./{name}.js?v=7"', index)
        self.assertIn('from "./features/players/index.js?v=7"', script)
    ...
    def test_browser_api_attaches_session_bound_csrf_header(self) -> None:
        ...
        self.assertIn('./api.js?v=7', app_script)
        self.assertIn('./api.js?v=7', auth_script)
    ...
    def test_frontend_core_owns_shared_state_and_dom_primitives(self) -> None:
        ...
        self.assertIn('from "./core/state.js?v=7"', script)
        self.assertIn('from "./core/dom.js?v=7"', script)
    ...
    def test_frontend_components_own_feedback_and_time_primitives(self) -> None:
        ...
        self.assertIn('from "./components/feedback.js?v=7"', script)
        self.assertIn('from "./components/time.js?v=7"', script)
