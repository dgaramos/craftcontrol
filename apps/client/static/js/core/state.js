import { tabFromLocation } from "./route.js?v=8";
...
export const state = createState({
  schema: null, config: {}, gamerules: {}, world: {}, players: [], online: 0, maxPlayers: 0,
  changes: {}, tab: tabFromLocation(), tabs: ["home", "world", "players", "analytics", "rules", "server"], status: null, updatedAt: 0, domains: {}, operationActive: false, operationStalled: false, operationState: null,
  analytics: { kind: "all", player: "", source: "all", search: "", days: 0, page: 1, rankingCategory: "activity", rankingMetric: "play_time", blocksMode: "mining", selectedOre: "diamond", combatMetric: "mob_kills", explorationMetric: "distance", interactionMetric: "itemUse", periodDays: 30, periodMetric: "play_seconds" },
