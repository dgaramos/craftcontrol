...
async function renderAnalyticsPanel() {
  ...
  // inline: complex conditional HTML with i18n labels and dynamic filter selects;
  // extraction would require ~10 nested templates with conditional visibility toggling.
  // All API data is escaped via escapeHtml before injection.
