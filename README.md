...
| `CRAFTCONTROL_FRONTEND_VERSION` | `0.1.7` | Independently deployable frontend image version |
...
The migration now produces independent `craftcontrol-frontend:0.1.7` and
