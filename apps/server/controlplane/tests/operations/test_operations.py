...
from src.operations.lifecycle import (
    OperationStage,
    OperationState,
    ServerOperation,
    StageResult,
...
class TestRepositoryEdgeCases:
    def test_write_connect_rolls_back_and_reraises_on_exception(self, tmp_path: Path):
        ...
        from src.operations.repository import _write_connect
...
class TestRecoveryAndReconciliation:
    ...
    def test_reconciliation_keeps_failed_when_no_verifiable_changes(self, tmp_path: Path):
        ...
        op.start()
        op.fail_stage(
            __import__("src.operations.lifecycle", fromlist=["OperationStage"]).OperationStage.REVIEW,
    ...
    def test_reconciliation_keeps_failed_with_mixed_verifiable_and_unverifiable_changes(self, tmp_path: Path):
        ...
        OperationStage = __import__(
            "src.operations.lifecycle", fromlist=["OperationStage"]
        ).OperationStage
