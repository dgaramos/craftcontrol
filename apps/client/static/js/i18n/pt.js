export const pt = {
    ...
    gameModeTitle: "Modo de jogo", gameModeHelp: "Altera o modo de jogo aplicado a este jogador em tempo de execução. Não reinicia o servidor.",
    gameModeLabel: "Definir modo de jogo", survival: "Sobrevivência", creative: "Criativo", adventure: "Aventura",
    gameModeUpdated: "Modo de jogo atualizado", gameModeError: "Não foi possível alterar o modo de jogo",
    ...
    telemetryDetails: "Estado da telemetria", persistenceDiagnostics: "Persistência SQLite", runtimeDiagnostics: "Trabalho do runtime", telemetryDuplicates: "Eventos duplicados", telemetryOld: "Eventos fora de ordem", diagnosticStatus: "Status", expectedSequence: "Sequência esperada", sqliteConnections: "Conexões SQLite", sqliteWaitAverage: "Espera média do SQLite", sqliteWaitMax: "Maior espera do SQLite", sqliteContentionFailures: "Falhas de contenção do SQLite", pendingGameruleRefreshes: "Atualizações de regras pendentes", gameruleWorkerRunning: "Worker de regras em execução", snapshotRunning: "Solicitação de snapshot em execução",
