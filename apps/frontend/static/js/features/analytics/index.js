import { createActivityView } from "./activity.js?v=1";
import { createRankingsPanel } from "./rankings.js?v=1";
import { createBlocksPanel } from "./blocks.js?v=1";
import { createCombatPanel } from "./combat.js?v=1";
import { createExplorationPanel } from "./exploration.js?v=1";
import { createTrendsPanel } from "./trends.js?v=1";
