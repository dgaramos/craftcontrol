...
export type PlayerSummary = { id: string; name: string; online: boolean; sessions_count: number; total_play_seconds: number; deaths_count: number; permission: string; operator: boolean; telemetry?: JsonMap; telemetry_updated_at?: NullableTimestamp; observed_game_mode?: unknown; preferred_game_mode?: unknown; };
...
export type GameModeResult = { ok: true; player: string; mode: "survival" | "creative" | "adventure" | "server_default"; preferred_game_mode?: unknown; };
