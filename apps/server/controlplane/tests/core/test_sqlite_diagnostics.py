...
from src.operations.repository import SQLiteOperationRepository, _connect as _ops_connect, _write_connect as _ops_write_connect
from src.players.repository import SQLitePlayerRepository
from src.telemetry.repository import SQLiteTelemetryRepository
from src.core.migrations import LATEST_SCHEMA_VERSION
import sqlite3
...
def test_initialize_new_database_increments_diagnostics(tmp_path: Path) -> None:
    ...
    from src.core.migrations import schema_version
...
def test_core_initialize_records_contention_failure(tmp_path: Path) -> None:
    ...
    from src.core import migrations as _mig
...
def test_open_connection_with_retry_increments_retries_on_contention(tmp_path: Path) -> None:
    ...
    import src.core.sqlite as _db_module
