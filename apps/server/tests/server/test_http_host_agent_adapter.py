...
from controlplane.server.host_agent import (
...
class TestIntendedStateKeyTranslation:
    ...
    def test_conflicting_aliases_uppercase_first_raises_value_error(self) -> None:
        ...
        from controlplane.server.host_agent import _translate_intended_state
    ...
    def test_every_restart_required_setting_has_a_host_agent_field(self) -> None:
        ...
        from controlplane.server.host_agent import _translate_intended_state
        from controlplane.core.schema import PROPERTY_NAMES, SETTINGS

        translated = _translate_intended_state({key: "value" for key in SETTINGS})
        agent_operations = Path(__file__).parents[4] / "services" / "host-agent" / "host_agent" / "runtime" / "operations.py"
