export const en = {
    ...
    gameModeTitle: "Game mode", gameModeHelp: "Change the game mode applied to this player at runtime. Does not restart the server.",
    gameModeLabel: "Set game mode", survival: "Survival", creative: "Creative", adventure: "Adventure",
    gameModeUpdated: "Game mode updated", gameModeError: "Could not change game mode",
    ...
    telemetryDetails: "Telemetry state", persistenceDiagnostics: "SQLite persistence", runtimeDiagnostics: "Runtime work", telemetryDuplicates: "Duplicate events", telemetryOld: "Out-of-order events", diagnosticStatus: "Status", expectedSequence: "Expected sequence", sqliteConnections: "SQLite connections", sqliteWaitAverage: "Average SQLite wait", sqliteWaitMax: "Longest SQLite wait", sqliteContentionFailures: "SQLite contention failures", pendingGameruleRefreshes: "Pending gamerule refreshes", gameruleWorkerRunning: "Gamerule worker running", snapshotRunning: "Snapshot request running",
